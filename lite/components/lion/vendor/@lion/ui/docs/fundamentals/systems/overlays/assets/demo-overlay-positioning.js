import"../../../../../../../chunks/chunk-EV5SWPUA.js";import{a as e,b as s}from"../../../../../../../chunks/chunk-E7IO7NYJ.js";import"../../../../../../../chunks/chunk-TCJO2LYM.js";import{e as i}from"../../../../../../../chunks/chunk-W6YAUKAV.js";import"../../../../../../../chunks/chunk-765SGQET.js";import"../../../../../../../chunks/chunk-RFUIJ2RA.js";import"../../../../../../../chunks/chunk-5G3K6R3U.js";import"../../../../../../../chunks/chunk-DSM4IEUY.js";import"../../../../../../../chunks/chunk-KVEQ5QLL.js";import"../../../../../../../chunks/chunk-JK7PRD3U.js";import"../../../../../../../chunks/chunk-G7OXZUGX.js";import"../../../../../../../chunks/chunk-7ONKQLO6.js";import"../../../../../../../chunks/chunk-GNR73WXY.js";import{b as a,d as n}from"../../../../../../../chunks/chunk-TIEK7LWH.js";import{a as r}from"../../../../../../../chunks/chunk-2FELQFK7.js";var p=class extends i(n){static get properties(){return{simulateViewport:{type:Boolean,attribute:"simulate-viewport",reflect:!0},noDialogEl:{type:Boolean,attribute:"no-dialog-el"},useAbsolute:{type:Boolean,attribute:"use-absolute",reflect:!0}}}static get styles(){return[super.styles||[],a`
    ...
    `};render(){let t=this.constructor;return(this.templates||t.templates).main(this._templateData)}};customElements.define("demo-overlay-el",p);var l=class extends n{static properties={placementMode:{attribute:"placement-mode",type:String},simulateViewport:{type:Boolean,attribute:"simulate-viewport",reflect:!0},_activePos:{type:String,reflect:!0,attribute:"active-pos"},_activeConfig:{type:Object,state:!0}};static get styles(){return[a`
      ...
      `]}refs={overlay:e()};constructor(){super(),this.placementMode="local",this._placements=[],this.simulateViewport=!1,this._activePos="top"}async _updatePos({pos:t}){this._activePos=t;let o=this.refs.overlay.value;o?._overlayCtrl&&(o.config={popperConfig:{placement:t},viewportConfig:{placement:t}},await o._overlayCtrl.hide(),o._overlayCtrl.show(),o.config={popperConfig:{placement:t},viewportConfig:{placement:t}})}firstUpdated(t){super.firstUpdated(t),this._updatePos({pos:this.placementMode==="local"?"top":"center"})}update(t){t.has("placementMode")&&(this.placementMode==="local"?this._placements=["top-start","top","top-end","right-start","right","right-end","bottom-start","bottom","bottom-end","left-start","left","left-end"]:this._placements=["center","top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"]),super.update(t)}updated(t){super.updated(t),t.has("placementMode")&&(this._activeConfig={placementMode:this.placementMode})}_isActivePosBtn({pos:t}){return t===this._activePos}render(){return r`
    ...
    `}};customElements.define("demo-overlay-positioning",l);
