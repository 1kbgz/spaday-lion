 ...
 *
 * This bundle registers every Lion element at import. An application that ships its own copy
 * of Lion rather than importing this one registers the same tag names, and whichever copy
